  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 max-w-5xl mx-auto">
      <div className="text-center mb-16">
          <span className="text-cyan-400 font-mono text-sm uppercase tracking-wider mb-4 block">Workflow</span>
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">From thought to tarmac.</h2>
      </div>
          ...
          <div className="space-y-12 relative z-10">
              {steps.map((step, idx) => (
                  <div key={idx} className={`flex flex-col md:flex-row items-start md:items-center gap-8 ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                      ...
                      {/* Icon Bubble */}
                      <div className="absolute left-0 md:left-1/2 -translate-x-0 md:-translate-x-1/2 w-12 h-12 rounded-full border-4 border-[#02040a] shadow-[0_0_20px_rgba(0,0,0,0.5)] flex items-center justify-center z-10 bg-slate-800">
