  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-24">
        <div className="bg-slate-900/40 rounded-3xl p-8 border border-white/10 backdrop-blur-md relative overflow-hidden group hover:bg-slate-900/60 transition-all hover:shadow-[0_0_30px_rgba(34,211,238,0.1)]">
